      ...
      <div class="register-box-body">
        ...
        <form action="<?=base_url('auth/register') ?>" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" autofocus="on" autocomplete="off" name="fullname" placeholder="Full name" value="<?= set_value('fullname') ?>">
          ...
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="nis" placeholder="NIS/NISN">
