                    ...
                    <div class="col-sm-offset-3 col-sm-6 col-lg-offset-4 col-lg-4">        
                      <div class="my-4">
                          <div class="form-horizontal form-inline">
                              <a href="<?=base_url('dashboard')?>" class="btn btn-default btn-xs">
                      ...
                      <table id="form-table" class="table text-center table-condensed">
                        ...
                        <?php
                          ...
                          <tr>
                            <td>Nama Lengkap<td>
                            <td><input type="text" name="nama_lengkap" class="form-control" value="<?=$profile['nama_lengkap'] ?>" readonly><td>
                          </tr>
                          <tr>
                            <td>NISN<td>
                            <td><input readonly autocomplete="off" autofocus="on" type="text" name="email" class="form-control" value="<?=$profile['email'] ?>"><?= form_error('email','<small class="text-danger pl-3">', '</small>'); ?><td>
                          </tr>
                        <?php
                        } ?>
                          <tr>
